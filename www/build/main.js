...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_file_opener__ = __webpack_require__(215);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__facebook_fbconnect_settings__ = __webpack_require__(45);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppCamera = /** @class */ (function () {
    function AppCamera(actionSheet, Camera, Device, Transfer, translate) {
    ...
    AppCamera = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__ionic_native_action_sheet__["a" /* ActionSheet */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__fbconnect_settings__ = __webpack_require__(45);
...
var AudioPlayerComponent = /** @class */ (function () {
    function AudioPlayerComponent(navParams, viewCtrl, streamingMedia, events) {
        ...
        this.duration = null;
        this.position = null;
        this.events.subscribe("audio_player_progress", function (object) {
            _this.progress = object.percent;
            if (object.duration)
                _this.duration = _this.numToTime(object.duration);
            if (object.position)
                _this.position = _this.numToTime(object.position);
        });
    }
    ...
    AudioPlayerComponent.prototype.numToTime = function (int) {
...
var WooProvider = /** @class */ (function () {
    ...
    WooProvider.prototype.addToCart = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var login_data, authUrlParams, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.storage.get('user_login')];
                    case 2:
                        login_data = _a.sent();
                        authUrlParams = (login_data) ? '?appp=3&token=' + login_data.access_token : '';
                        return [2 /*return*/, this.http.post(this.url + this.cartRest + '/add' + authUrlParams, data, this.httpOptions).toPromise()];
                    case 3:
                        error_1 = _a.sent();
                        // probably a bad url or 404
    ...
    WooProvider.prototype.clearCart = function () {
        return __awaiter(this, void 0, void 0, function () {
            var login_data, authUrlParams, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        login_data = _a.sent();
                        authUrlParams = (login_data) ? '?appp=3&token=' + login_data.access_token : '';
                        return [2 /*return*/, this.http.delete(this.url + this.cartRest + '/clear' + authUrlParams, this.httpOptions).toPromise()];
                    case 2:
                        error_2 = _a.sent();
                        // probably a bad url or 404
    ...
    WooProvider.prototype.getCartContents = function () {
        return __awaiter(this, void 0, void 0, function () {
            var login_data, authUrlParams, response, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        login_data = _a.sent();
                        authUrlParams = (login_data) ? '&appp=3&token=' + login_data.access_token : '';
                        return [4 /*yield*/, this.http.get(this.url + this.cartRest + '?thumb=true' + authUrlParams, this.httpOptions).toPromise()];
                    case 2:
                        response = _a.sent();
    ...
    WooProvider.prototype.removeItem = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var login_data, authUrlParams, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        login_data = _a.sent();
                        authUrlParams = (login_data) ? '&appp=3&token=' + login_data.access_token : '';
                        return [2 /*return*/, this.http.delete(this.url + this.cartRest + '/cart-item?cart_item_key=' + item.key + authUrlParams, this.httpOptions).toPromise()];
                    case 2:
                        error_4 = _a.sent();
                        // probably a bad url or 404
    ...
    WooProvider.prototype.updateItem = function (item, quantity) {
        return __awaiter(this, void 0, void 0, function () {
            var login_data, authUrlParams, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        login_data = _a.sent();
                        authUrlParams = (login_data) ? '&appp=3&token=' + login_data.access_token : '';
                        return [2 /*return*/, this.http.post(this.url + this.cartRest + '/cart-item?cart_item_key=' + item.key + '&quantity=' + quantity + authUrlParams, null, this.httpOptions).toPromise()];
                    case 2:
                        error_5 = _a.sent();
                        // probably a bad url or 404
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ngx_translate_core__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ngx_translate_core__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_file__ = __webpack_require__(56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__ionic_native_streaming_media__ = __webpack_require__(213);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__ionic_native_media__ = __webpack_require__(214);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__ionic_native_file_opener__ = __webpack_require__(215);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__providers_facebook_fbconnect_settings__ = __webpack_require__(45);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_53_angulartics2_ga__ = __webpack_require__(216);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_54_angulartics2_routerlessmodule__ = __webpack_require__(381);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_55__providers_analytics_analytics_service__ = __webpack_require__(55);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_facebook_fbconnect_settings__ = __webpack_require__(45);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__providers_analytics_analytics_service__ = __webpack_require__(55);
        ...
        this.zone.run(function () {
            ...
            if (!login || lang_updated) {
                if (lang_updated) {
                    ...
                    var homePage = _this.navparams[0]; // Select the first page (which probably is going to be the homepage) from the navparms variable (all tab pages)
                    if (homePage.root === 'PostList') {
                        var root_1 = _this.getPageType(homePage);
                        if (root_1) {
                            _this.nav.setRoot(root_1, homePage);
                        }
                    }
                    else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_angulartics2_ga__ = __webpack_require__(216);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__providers_analytics_analytics_service__ = __webpack_require__(55);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_native_streaming_media__ = __webpack_require__(213);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_file__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_device__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_media__ = __webpack_require__(214);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ionic_angular__ = __webpack_require__(10);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
            ...
            _this.progress = setInterval(function () {
                ...
                _this.currentTrack.getCurrentPosition()
                    ...
                    if (position > -1) {
                        ...
                        _this.events.publish("audio_player_progress", { duration: dur, position: position, percent: percentCompleted });
                    }
                })
                    .catch(function (e) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__analytics_analytics_service__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ngx_translate_core__ = __webpack_require__(41);
